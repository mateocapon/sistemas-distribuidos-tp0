...
def initialize_config():
    ...
    try:
        ...
        config_params["number_clients"] = int(os.getenv('NUMBER_CLIENTS', config["DEFAULT"]["NUMBER_CLIENTS"]))
...
def main():
    ...
    try:
        server = Server(port, listen_backlog, number_clients, number_processes_pool)
        server.run()
    except OSError as e:
